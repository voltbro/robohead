...
class TurtlebotController(RoboheadController):
    def _turtlebot_odom_pose2d_callback(self, msg:Pose2D):
        self.turtlebot_odom_pose2d = msg
    ...
    def __init__(self):
        ...
        turtlebot_topic_odom_pose2d_name = rospy.get_param('~turtlebot_topic_odom_pose2d_name')
