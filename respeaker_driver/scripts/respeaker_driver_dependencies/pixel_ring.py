...
class PixelRing():
    ...
    def set_color_manual(self, data:list):
        ...
        # data=[r,g,b]*12 - устанавливает каждый из 12 светодиодов в свой цвет
        # Пример для заполнения всех 12ти светодиодов:
        # self.set_color_manual([255,255,255, # 1
        #                                 0,0,255, # 2
        #                                 255,0,0, # 3
        #                                 0,255,0, # 4
        #                                 255,255,255, # 5
