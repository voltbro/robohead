...
# msg.colors - массив из 12 сообщений типа std_msgs/ColorRGBA, компонент прозрачности A не используется. Задавть целые значения от 0 до 255
...
for i in range(12):
    msg.colors[i].r = 120 + 120 * (-1)**i
    msg.colors[i].g = 120 + 120 * (-1)**(i+1)
    msg.colors[i].b = 120 + 120 * (-1)**i
    msg.colors[i].a = 0 # Не используется
